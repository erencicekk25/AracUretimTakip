    ...
    public partial class mig_init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Admin", "123456789", "admin" });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "ID", "LastLoginDate", "NameSurname", "Password", "UserName" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "User", "123456789", "user" });
        }
